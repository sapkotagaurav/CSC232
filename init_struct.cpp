...
int main()
{
    ...
    taxPayer citizen1 = taxPayer{"Tim McGuiness",255871234,0.35};
    taxPayer citizen2 = taxPayer{"John Kane",278990582,0.29};
    ...
    cout<<"Enter the income for "<< citizen1.name<<endl;
	...
	// Fill in code to prompt the user to enter this year's income for citizen2
        cout<<"Enter the income for "<< citizen2.name<<endl;
